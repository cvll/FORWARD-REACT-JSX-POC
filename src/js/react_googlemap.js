...
var MyGoogleMap = React.createClass({
  ...
  componentWillReceiveProps: function(nextProps) {
    ...
    this.handleMapOptionChange(nextProps.mapOptions)
    this.forceUpdate(); 
  },
  handleMapOptionChange : function(options) {
  ...
  initMap: function() {
    ...
    if (this.props.mapOptions) {
      ops = this.props.mapOptions;
    }
    this.state.map = new google.maps.Map(React.findDOMNode(this),ops);
  },
